...
form.addEventListener('submit', sendLogin); // When the button is pressed you call sendLogin()

function sendLogin(e) {
  console.log('Someone clicked submit and sendLogin() is called');
  // prevent page from refreshing when form is submitted
  e.preventDefault();

  // Calls a POST API to check the login info
