...
const app = express(); // Necessary syntax for Express
...
// URL Constructor
const urlVar = new URL("https://www.trademe.co.nz/a/search?search_string=le%20snak");
...
// Bonus Endpoint: localhost:4000/book/LOTR
app.get("/api/book/:bookName", (req, res) => {
  console.log("Received a GET request to /book");
  const { bookName } = req.params;
  res.send(`You have asked something about ${bookName}`);
});

// Query
app.get("/api/books", (req, res) => {
  console.log("Received a GET request to /book", req.query);

  res.send(`You have asked something about ${req.query.test}`);
});
