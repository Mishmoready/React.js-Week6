...
let iAmEmpty;
console.log(typeof iAmEmpty); // undefined

let myTestNull = null;
console.log(typeof myTestNull); // object (but should really be null)
...
// ---------Bonus Content --------- will make more sense after Monday's session
